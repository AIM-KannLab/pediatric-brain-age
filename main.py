...
parser.add_argument(
    ...
    type=str,
    default=None,
    help="Evaluate best model during training, path to the best model",
)
...
parser.add_argument(
    ...
    type=str,
    default=None,
    help="Evaluate best aux model during training, path to the best model",
)
...
parser.add_argument(
    "--n_splits", type=int, default=1, help="total number of runs with different seeds for a specific task"
)
parser.add_argument(
...
# )
parser.add_argument(
    "--loss", type=str, default='diffmic_conditional', help="loss function"
)
...
if __name__ == "__main__":
    ...
    if args.test and '.yml' not in args.config:
